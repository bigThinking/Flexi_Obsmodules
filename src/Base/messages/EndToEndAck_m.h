...
class EndToEndAck : public ::TransmittedMessage_Base
{
  ...
  public:
    ...
    virtual double getBlrApprox() const;
    virtual void setBlrApprox(double blrApprox);
    virtual int getBcpLostOnRoute() const;
    virtual void setBcpLostOnRoute(int bcpLostOnRoute);
    virtual int getTotalBCPSentOnRoute() const;
    virtual void setTotalBCPSentOnRoute(int totalBCPSentOnRoute);
};
